...
const WRITING_TOPICS = {
  ...
  strong_verbs: {
    ...
    exercises: [
      ...
      { type: 'arrange', prompt: 'Build this vivid sentence:', words: ['She','across','sprinted','field','the'], correctOrder: [0,2,1,4,3], sentence: 'She sprinted across the field', feedback: 'SPRINTED — so much better than "ran"! 🏃‍♀️' },
  ...
  colorful_adj: {
    ...
    exercises: [
      ...
      { type: 'arrange', prompt: 'Build this descriptive sentence:', words: ['enormous','spotted','The','leaped','giraffe','gracefully'], correctOrder: [2,0,1,4,3,5], sentence: 'The enormous spotted giraffe leaped gracefully', feedback: 'ENORMOUS SPOTTED — stacked adjectives create a vivid image! 🦒' },
  ...
  sensory_details: {
    ...
    exercises: [
      ...
      { type: 'arrange', prompt: 'Build this sensory sentence:', words: ['golden','The','sizzled','butter','pan','in the'], correctOrder: [1,0,3,2,5,4], sentence: 'The golden butter sizzled in the pan', feedback: 'SIZZLED — a sound that brings the kitchen to life! 🍳' },
  ...
  joining_words: {
    ...
    exercises: [
      ...
      { type: 'arrange', prompt: 'Build the sentence:', words: ['raining','we','Although','went','was','it','outside'], correctOrder: [2,5,4,0,1,3,6], sentence: 'Although it was raining we went outside', feedback: 'ALTHOUGH shows a surprising contrast! 🌧️' },
  ...
  expand_sentence: {
    ...
    exercises: [
      ...
      { type: 'arrange', prompt: 'Build this expanded sentence:', words: ['slowly','the','foggy','A','through','ship','sailed','harbor'], correctOrder: [3,5,0,6,4,1,2,7], sentence: 'A ship slowly sailed through the foggy harbor', feedback: 'So much better than "A ship sailed through the harbor"! ⛵' },
  ...
  support_details: {
    ...
    exercises: [
      ...
      { type: 'arrange', prompt: 'Order: Topic sentence FIRST, then details:', words: ['Cats make excellent indoor pets.','They do not need to be taken for walks.','Cats clean themselves, so bathing is rarely needed.','They are quiet and do not disturb neighbors.'], correctOrder: [0,1,3,2], sentence: 'Cats make excellent indoor pets. They do not need to be taken for walks. They are quiet and do not disturb neighbors. Cats clean themselves, so bathing is rarely needed.', feedback: 'Topic sentence first, then three supporting details that all connect! 🐱' },
  ...
  concluding_sentence: {
    ...
    exercises: [
      ...
      { type: 'arrange', prompt: 'Order from topic sentence to conclusion:', words: ['Without doubt, the ocean is one of Earth\'s greatest treasures.','The ocean covers 71% of our planet\'s surface.','The ocean is the most important ecosystem on Earth.','It provides food, oxygen, and regulates our climate.'], correctOrder: [2,1,3,0], sentence: 'The ocean is the most important ecosystem on Earth. The ocean covers 71% of our planet\'s surface. It provides food, oxygen, and regulates our climate. Without doubt, the ocean is one of Earth\'s greatest treasures.', feedback: 'Topic → Details → Conclusion: "Without doubt..." — a satisfying paragraph ending! 🌊' },
  ...
  descriptive_writing: {
    ...
    exercises: [
      ...
      { type: 'arrange', prompt: 'Build this descriptive sentence with personification:', words: ['danced','The','playfully','through','fireflies','the','darkness'], correctOrder: [1,4,0,2,3,5,6], sentence: 'The fireflies danced playfully through the darkness', feedback: '"Danced" — fireflies don\'t actually dance, but it creates a beautiful image! ✨' },
  ...
  my_dream_day: {
    ...
    exercises: [
      ...
      { type: 'arrange', prompt: 'Order the 5 paragraphs of an opinion essay:', words: ['Paragraph with Reason 3 + evidence','Strong conclusion that restates opinion in new words','Attention-grabbing hook + clear opinion statement','Paragraph with Reason 1 + evidence','Paragraph with Reason 2 + evidence'], correctOrder: [2,3,4,0,1], sentence: 'Attention-grabbing hook + clear opinion statement Paragraph with Reason 1 + evidence Paragraph with Reason 2 + evidence Paragraph with Reason 3 + evidence Strong conclusion that restates opinion in new words', feedback: 'Introduction → Reason 1 → Reason 2 → Reason 3 → Conclusion: the 5-paragraph essay! 📋' },
